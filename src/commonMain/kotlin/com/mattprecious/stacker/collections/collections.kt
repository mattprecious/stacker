...
fun <K : Any, T : Any> treeOf(
  ...
  return Tree(elements = elements, keySelector, parentMap = parents, childMap = children).root
}
...
@Stable
class TreeNode<T : Any> internal constructor(private val tree: Tree<*, T>, val value: T) {
  val root: TreeNode<T>
    get() = tree.root
