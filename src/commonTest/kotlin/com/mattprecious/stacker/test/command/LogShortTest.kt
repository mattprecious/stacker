...
class LogShortTest {
  ...
  private enum class NoRestackCase(
    ...
    One(branches = listOf("main" to null), output = "● main"),
    Two(
      branches = listOf("main" to null, "a" to "main"),
      output =
        """
        |○ a
        |● main
    ...
    Three(
      branches = listOf("main" to null, "a" to "main", "b" to "a"),
      output =
        """
        |○ b
        |○ a
    ...
    TwoChildren(
      branches = listOf("main" to null, "a" to "main", "b" to "main"),
      output =
        """
        |○   a
        |│ ○ b
    ...
    ThreeChildren(
      branches = listOf("main" to null, "a" to "main", "b" to "main", "c" to "main"),
      output =
        """
        |○     a
        |│ ○   b
  ...
  @Test
  private fun noRestacksRequired(case: NoRestackCase) = withTestEnvironment {
    gitInit()
    gitCommit("Empty")
    ...
    testCommand({ logShort() }) { awaitFrame(static = case.output, output = "") }
  }
